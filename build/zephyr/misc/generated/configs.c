...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAY_HELLO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_SAY_HELLO_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F446RE_STM32F446XX, 1);
