...
.intList :
{
 ...
 KEEP(*(.gnu.attributes))
    ...
    BACKUP_SRAM (NOLOAD) : { __BACKUP_SRAM_start = .; KEEP(*(BACKUP_SRAM)) KEEP(*(BACKUP_SRAM.*)) __BACKUP_SRAM_end = .; } > BACKUP_SRAM __BACKUP_SRAM_size = __BACKUP_SRAM_end - __BACKUP_SRAM_start; __BACKUP_SRAM_load_start = LOADADDR(BACKUP_SRAM);
.last_section :
{
  LONG(0xE015E015)
} > FLASH
